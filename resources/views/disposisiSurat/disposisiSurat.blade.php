            ...
            <table class="table table-hover content live" id="surat-keluar" style="width:100%;">
              ...
              <tbody>
                    <tr>
                        ...
                        <td>
                            <button type="submit" class="btn buttonCustom daftar-surat-masuk btn-primary mb-2" style="display: block;"><i class=" icon-printer"></i> Print</button>
                        </td>
                    </tr>
              </tbody>
            </table>
